  ...
  return (
    <ResponsiveContainer width="100%" height={280}>
      <BarChart data={dados} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
        ...
        <XAxis dataKey="ticker" stroke="#94a3b8" tick={{ fill: '#94a3b8', fontSize: 12 }} axisLine={{ stroke: '#475569' }} />
        <YAxis
          stroke="#94a3b8"
        ...
        <Bar dataKey="investido" name="Investido" fill={COR_INVESTIDO} radius={[4, 4, 0, 0]} />
